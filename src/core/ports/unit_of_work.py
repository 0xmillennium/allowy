...
class AbstractUnitOfWork(ABC):
    """Async context manager that groups repository operations into a single transaction.
    ...
    def collect_new_events(self) -> Generator[Event, None, None]:
        """Yields and clears domain events from all entities seen during the transaction."""
